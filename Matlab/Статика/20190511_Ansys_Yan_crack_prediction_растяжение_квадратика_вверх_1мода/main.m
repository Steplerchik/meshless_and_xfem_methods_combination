...
Yc = [yc1 yc2];
Xc = [xc1 xc2];
Kin1_tip1_(1,:) = SIF(1,n,P,X,Y,kol,a,i_edge,i_tip1,i_tip2,Xc,Yc,G,k,u);
Kin2_tip2_(1,:) = SIF(2,n,P,X,Y,kol,a,i_edge,i_tip1,i_tip2,Xc,Yc,G,k,u);
Kin1_tip1_percent = [abs(Kin1_tip1_(1,1)-Kin1)/Kin1 abs(Kin1_tip1_(1,2)-Kin2)/Kin2];
